# AGENTS.md — Dev Intelligence Platform (GitHub-only)

Orientation file for Codex. Read this first. It states the scope, the signal-confidence principle that governs what we build, the locked stack, and the doc map.
